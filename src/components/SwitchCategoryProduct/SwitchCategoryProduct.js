...
import { API_PRODUCT_URL, slugs } from "../../constants";
        ...
        for (const category of groupCategory.categories) {
          if (category.slug === slug) {
            return (
              <ProductsCategory
                category={category}
                query={`${API_PRODUCT_URL}/category/slug/${category.slug}`}
            ...
            if (groupProduct.slug === slug) {
              return (
                <ProductsCategory
                  ...
                  query={`${API_PRODUCT_URL}/group-product/slug/${groupProduct.slug}`}
