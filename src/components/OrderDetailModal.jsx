      ...
      >
        ...
        >
          <li style={{ display: "flex", marginTop: "8px" }}>
            ...
            <div style={{ flex: "1" }}>
              {item?.user?.last_name}&nbsp;{item?.user?.middle_name}&nbsp;
            ...
            return (
              ...
              >
                <img
                  ...
                  src={(() => {
                    try {
                      return order_item.detail.product.images.find(
                        (element) =>
                          element.color_id === order_item.detail.color.id
                      ).url;
                    } catch (error) {
                      return "";
                    }
                ...
                >
                  <div
                    ...
                    style={{ fontSize: "14px" }}
                  >
                    {order_item.detail.product.name}
                  </div>
                  <div
                    style={{
                      fontSize: "12px",
                  ...
                  >
                    <div>
                      Màu sắc:&nbsp;
                      <b>{order_item.detail.color.value}</b>
                    </div>
                    <div
                      style={{
                        width: "6px",
                    ...
                    <div>
                      Kích cỡ:&nbsp;
                      <b>{order_item.detail.size.value}</b>
                    </div>
                  </div>
                  <div
                    style={{
                  ...
                  >
                    ...
                    <b style={{ color: "var(--main-color)" }}>
                      {(order_item.quantity * order_item.product_price)
                        .toString()
                        .replace(/\B(?=(\d{3})+(?!\d))/g, ".")}
                      đ
                    </b>
          ...
          <table style={{ textAlign: "right" }}>
            <tbody>
              <tr style={{ fontSize: "12px" }}>
                <td>Giảm giá:</td>
                <td>
                  <b style={{ color: "var(--main-color)" }}>{0}đ</b>
                </td>
              </tr>
